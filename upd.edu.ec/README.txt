...
a persistence unit "upd.edu.ecPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "upd.edu.ec/pom.xml":
...
artifact ("upd.edu.ec.war") is already built. You can build
